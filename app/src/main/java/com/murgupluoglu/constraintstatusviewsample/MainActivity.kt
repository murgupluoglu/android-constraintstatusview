...
class MainActivity : AppCompatActivity() {
    ...
    private suspend fun test1(){
        ...
        delay(2 * 1000)
        val view = statusView.showCustom(R.layout.custom_status_error)
    ...
    private suspend fun test2(){
        delay(2 * 1000)
        val view = statusView.showCustom(R.layout.custom_status_error, "STATUSVIEW_MYCUSTOM")
        val messageTextView = view.findViewById<TextView>(R.id.messageTextView)
        messageTextView.text = "Changed Text From Code"
        delay(2 * 1000)
        statusView.showContent()
        delay(2 * 1000)
        statusView.showCustom(R.layout.custom_status_error, "STATUSVIEW_MYCUSTOM")
    }
}
